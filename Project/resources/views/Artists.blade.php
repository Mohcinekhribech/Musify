<body class=" bg-[#181818] ">
    <main class="flex">
        ...
        <div class="my-6 mx-4 display">
            <div class="w-[200px] h-[250px] bg-[#1d1d1d]">
                <img class="rounded-full w-40 h-40 p-2 mx-auto" src="https://i.scdn.co/image/ab6761610000e5eb4f7871da4c109d61ef283217">
                <h3 class="font-medium mx-4 mt-4 text-[#EEF2F7] text-lg">Artist Name</h3>
                <h4 class="font-medium mx-4 text-[#d3d7dc] text-sm">Arttist</h4>
            </div>
            <div class="w-[200px] h-[250px] bg-[#1d1d1d]">
                <img class="rounded-full w-40 h-40 p-2 mx-auto" src="https://i.scdn.co/image/ab6761610000e5eb4f7871da4c109d61ef283217">
                <h3 class="font-medium mx-4 mt-4 text-[#EEF2F7] text-lg">Artist Name</h3>

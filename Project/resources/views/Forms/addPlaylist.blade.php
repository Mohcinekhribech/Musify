<div class="flex min-h-full bg-[#181818] items-center justify-center px-4 sm:px-6 lg:px-8">
    <div class="w-full max-w-md space-y-8">
        <div>
            <h2 class="mt-6 text-center text-3xl font-bold tracking-tight text-[#7B818A]">Add Playlist</h2>
        </div>
        <form method="POST" action="/Musify/Project/public/playlists/store" enctype="multipart/form-data">
            @csrf
            <div class="row mb-3">
                <div class="col-md-6">
                    <label class="">
                        <span class="text-sm text-[#a9bbd5]">Shoose a picture</span>
                        <input type="file" name="playlisPic" required
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    <span class="text-sm text-[#7B818A]">playlist Name</span>
                    <input type="text"
                        ...
                        name="playlisName" required placeholder="playlist Name" autofocus>
                </div>
                @error('playlisName')
                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                @enderror

<div class="flex min-h-full bg-[#181818] items-center justify-center px-4 sm:px-6 lg:px-8">
    <div class="w-full max-w-md space-y-8">
        ...
        <form method="POST" action="/Musify/Project/public/admin/Artist/store" enctype="multipart/form-data">
            @csrf
            <div class="row mb-3">
                <div class="col-md-6">
                    <label class="">
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="text"
                        class="relative block w-full appearance-none my-2 rounded-none rounded-t-md border px-3 py-2 text-[#5f6164] placeholder-[#c7cad0]  focus:z-10  focus:outline-none sm:text-sm "
                        name="country" required placeholder="Country" autofocus>
                </div>
                @error('country')
                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                @enderror
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="date"
                        class="relative block w-full appearance-none my-2 rounded-none rounded-t-md border px-3 py-2 text-[#5f6164] placeholder-[#c7cad0]  focus:z-10  focus:outline-none sm:text-sm "
                        name="date_of_birth" required placeholder="date_of_birth" autofocus>
                </div>
                @error('date_of_birth')
                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                @enderror

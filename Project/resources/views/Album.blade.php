            ...
            <div class="flex flex-col justify-between flex-1 mt-6">
                <div>
                    ...
                    <a href=""
                        ...
                        <span class="side hidden mx-6">Albums</span>
                    </a>
                    <a href=""
                        class="flex items-center px-2 py-2 mt-5 transition-colors duration-300 transform rounded-sm text-[#b8bcc0] hover:bg-[#7B818A] hover:text-[#181818]">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
        ...
        <div class="w-full mt-2 h-screen overflow-auto">
            <div class="relative bg-[url('background/b2.jpg')] h-[50vh] bg-cover mx-4">
                ...
                <div class="backdrop-brightness-[60%] h-full w-full">
                    <h2 class="font-bold text-[#EEF2F7] text-5xl pt-6 pl-8">Album Name</h2>
                    <h3 class="font-bold text-[#EEF2F7] text-3xl pt-4 pl-8">Artist Name</h3>
                    <h4 class="font-bold text-[#EEF2F7] text-2xl pt-2 pl-8">413 Listen</h4>
                ...
                <table class="w-full text-sm text-left ">
                    ...
                    <tbody>
                        ...
                        <tr
                            ...
                            <th class="">
                                <center>
                                    <div class="border-[0.3px]  border-[#7B818A] rounded-full p-2  w-fit text">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                            stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                            <path stroke-linecap="round" stroke-linejoin="round"
                                                d="M5.25 5.653c0-.856.917-1.398 1.667-.986l11.54 6.348a1.125 1.125 0 010 1.971l-11.54 6.347a1.125 1.125 0 01-1.667-.985V5.653z" />
                            ...
                            <th scope="row" class="px-6 py-4 flex font-medium whitespace-nowrap">
                                <img src="background/b1.jpg" class="h-[50px] w-[50px]" alt="">
                                <div>
                                    Title
                                </div>
                            </th>

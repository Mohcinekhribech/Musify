    <div class="flex min-h-full bg-[#181818] items-center justify-center px-4 sm:px-6 lg:px-8">
        <div class="w-full max-w-md space-y-8">
            <div class="card">
                <div class="mt-6 text-center text-3xl font-bold tracking-tight text-[#7B818A]">Register</div>

                <div class="card-body">
                    <form method="POST" action="/Musify/Project/public/user/store">
                        @csrf

                        <div class="row mb-3">
                            <label for="name" class="col-md-4 text-[#7B818A] col-form-label text-md-end">Name</label>
                            ...
                            <div class="col-md-6">
                                ...
                                @error('name')
                                    <span class="font-medium text-red-500" role="alert">
